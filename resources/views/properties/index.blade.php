...
@section('content')
    ...
    <section class="property-content">
        <div class="container">
            <div class="row">
                <aside class="col-md-3 desktop_filter">
...
view_filter();
         ...
         function view_filter (){
             if(document.documentElement.clientWidth > 768 ){
                 const mobile = document.querySelector('.mobile_filter');
                 while (mobile.firstChild) {
                     mobile.removeChild(mobile.firstChild);
                 }

                 const parent = document.querySelector('.desktop_filter');
                 parent.insertAdjacentHTML('afterbegin', `<x-filter/>`);


             } else {
                 const desktop = document.querySelector('.desktop_filter');
                 while (desktop.firstChild) {
                     desktop.removeChild(desktop.firstChild);
                 }
                 const parent = document.querySelector('.mobile_filter');
                 parent.insertAdjacentHTML('afterbegin', `<x-filter/>`);
